...
def get_frcnn_model(num_classes: int, pre_trained_weights: str):
    """
    Load frcnn pretrained model
    :param num_classes:
    :return:
    """
    print("Loading FRCNN pretrained model")

    # load fasterRCNN model
    model = fasterrcnn_resnet50_fpn(pretrained=False)

    # Load pretrained state dict
    pretrained = torch.load(pre_trained_weights)
...
def load_frcnn(model_path:str, device:str, score_threshold:float = 0.5):
