...
class CocoEvaluator(object):
    ...
    # def summarize_extended(self, categoryId=None):
    #     '''
    #     Compute and display summary metrics for evaluation results.
    #     Note this functin can *only* be applied on the default parameter setting
    #     '''
    #     cocoEval = self.coco_eval["bbox"]
    #
    ...
    #
    #         if categoryId:
    #             iStr = ' {:<18} {} @[ CategoryId={:>3s} | IoU={:<9} | area={:>6s} | maxDets={:>3d} ] = {:0.3f}'
    #         else:
    ...
    #         if categoryId:
    #             cat_name = cocoEval.cocoGt.loadCats(categoryId)[0]["name"]
    #             print(iStr.format(titleStr, typeStr, str(cat_name), iouStr, areaRng, maxDets, mean_s))
    #         else:
    ...
    #         stats = np.zeros((27,))
    #         stats[0] = _summarize(1, iouThr=0.8, maxDets=cocoEval.params.maxDets[-1], categoryId=categoryId)
    ...
    #         # stats[6] = _summarize(1, iouThr=.25, areaRng='small', maxDets=cocoEval.params.maxDets[-1],
    #         #                       categoryId=categoryId)
    #         # stats[8] = _summarize(1, iouThr=.30, areaRng='small', maxDets=cocoEval.params.maxDets[-1],
    #         #                       categoryId=categoryId)
    #         # stats[9] = _summarize(1, iouThr=.5, areaRng='small', maxDets=cocoEval.params.maxDets[-1],
    #         #                       categoryId=categoryId)
    #         # stats[10] = _summarize(1, areaRng='medium', maxDets=cocoEval.params.maxDets[-1], categoryId=categoryId)
    #         # stats[11] = _summarize(1, iouThr=.25, areaRng='medium', maxDets=cocoEval.params.maxDets[-1],
    #         #                        categoryId=categoryId)
    #         # stats[12] = _summarize(1, iouThr=.30, areaRng='medium', maxDets=cocoEval.params.maxDets[-1],
    #         #                        categoryId=categoryId)
    #         # stats[13] = _summarize(1, iouThr=.5, areaRng='medium', maxDets=cocoEval.params.maxDets[-1],
    #         #                        categoryId=categoryId)
    #         # stats[14] = _summarize(1, areaRng='large', maxDets=cocoEval.params.maxDets[-1], categoryId=categoryId)
    #         # stats[15] = _summarize(1, iouThr=.25, areaRng='large', maxDets=cocoEval.params.maxDets[-1],
    #         #                        categoryId=categoryId)
    #         # stats[16] = _summarize(1, iouThr=.30, areaRng='large', maxDets=cocoEval.params.maxDets[-1],
    #         #                        categoryId=categoryId)
    #         # stats[17] = _summarize(1, iouThr=.5, areaRng='large', maxDets=cocoEval.params.maxDets[-1],
    #         #                        categoryId=categoryId)
